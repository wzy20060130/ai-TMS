...
export declare class VerifyWithFusionAuthTokenResponseBodyModel extends $dara.Model {
    /**
     * @remarks
...
export declare class VerifyWithFusionAuthTokenResponseBody extends $dara.Model {
    /**
     * @remarks
