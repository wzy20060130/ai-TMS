...
class Client extends openapi_core_1.default {
     ...
     */
    async createSmsAppIcpRecordWithOptions(request, runtime) {
        request.validate();
        let query = {};
        ...
        return $dara.cast(await this.callApi(params, req, runtime), new $_model.CreateSmsAppIcpRecordResponse({}));
    }
    /**
     * 创建APP-ICP备案对客openAPI
     *
     ...
     * @returns CreateSmsAppIcpRecordResponse
     */
    async createSmsAppIcpRecord(request) {
        let runtime = new $dara.RuntimeOptions({});
     ...
     */
    async createSmsTrademarkWithOptions(request, runtime) {
        request.validate();
        let query = {};
        if (!$dara.isNull(request.ownerId)) {
            query["OwnerId"] = request.ownerId;
        ...
        return $dara.cast(await this.callApi(params, req, runtime), new $_model.CreateSmsTrademarkResponse({}));
    }
    /**
     * 创建商标对客openAPI
     *
     ...
     * @returns CreateSmsTrademarkResponse
     */
    async createSmsTrademark(request) {
        let runtime = new $dara.RuntimeOptions({});
     ...
     */
    async getSmsTemplateListWithOptions(tmpReq, runtime) {
        tmpReq.validate();
        let request = new $_model.GetSmsTemplateListShrinkRequest({});
        openapi_core_2.OpenApiUtil.convert(tmpReq, request);
        if (!$dara.isNull(tmpReq.usableStateList)) {
            request.usableStateListShrink = openapi_core_2.OpenApiUtil.arrayToStringWithSpecifiedStyle(tmpReq.usableStateList, "UsableStateList", "json");
        }
        let query = {};
        ...
        return $dara.cast(await this.callApi(params, req, runtime), new $_model.GetSmsTemplateListResponse({}));
    }
    /**
     * 查询模板列表详情（新接口）
     *
     ...
     * @returns GetSmsTemplateListResponse
     */
    async getSmsTemplateList(request) {
        let runtime = new $dara.RuntimeOptions({});
     ...
     */
    async querySmsAppIcpRecordWithOptions(tmpReq, runtime) {
        tmpReq.validate();
        let request = new $_model.QuerySmsAppIcpRecordShrinkRequest({});
        openapi_core_2.OpenApiUtil.convert(tmpReq, request);
        if (!$dara.isNull(tmpReq.appIcpRecordIdList)) {
            request.appIcpRecordIdListShrink = openapi_core_2.OpenApiUtil.arrayToStringWithSpecifiedStyle(tmpReq.appIcpRecordIdList, "AppIcpRecordIdList", "json");
        }
        let query = {};
        ...
        return $dara.cast(await this.callApi(params, req, runtime), new $_model.QuerySmsAppIcpRecordResponse({}));
    }
    /**
     * 查询APP-ICP备案对客openAPI
     *
     ...
     * @returns QuerySmsAppIcpRecordResponse
     */
    async querySmsAppIcpRecord(request) {
        let runtime = new $dara.RuntimeOptions({});
     ...
     */
    async querySmsTrademarkWithOptions(tmpReq, runtime) {
        tmpReq.validate();
        let request = new $_model.QuerySmsTrademarkShrinkRequest({});
        openapi_core_2.OpenApiUtil.convert(tmpReq, request);
        if (!$dara.isNull(tmpReq.trademarkIdList)) {
            request.trademarkIdListShrink = openapi_core_2.OpenApiUtil.arrayToStringWithSpecifiedStyle(tmpReq.trademarkIdList, "TrademarkIdList", "json");
        }
        let query = {};
        if (!$dara.isNull(request.ownerId)) {
            query["OwnerId"] = request.ownerId;
        ...
        return $dara.cast(await this.callApi(params, req, runtime), new $_model.QuerySmsTrademarkResponse({}));
    }
    /**
     * 查询商标对客openAPI
     *
     ...
     * @returns QuerySmsTrademarkResponse
     */
    async querySmsTrademark(request) {
        let runtime = new $dara.RuntimeOptions({});
