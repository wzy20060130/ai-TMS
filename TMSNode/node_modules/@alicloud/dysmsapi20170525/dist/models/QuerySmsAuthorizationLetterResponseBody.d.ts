...
export declare class QuerySmsAuthorizationLetterResponseBodyData extends $dara.Model {
    /**
     * @remarks
     * 委托授权方
     *
...
export declare class QuerySmsAuthorizationLetterResponseBody extends $dara.Model {
